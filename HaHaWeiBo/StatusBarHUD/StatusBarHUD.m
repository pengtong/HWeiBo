...
+ (void)showLoading:(NSString *)msg
{
    ...
    CGSize labelTextSize = [label.text sizeWithFont:label.font maxSize:label.frame.size];
    // 圈圈
    UIActivityIndicatorView *indicatorView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhite];
    [indicatorView startAnimating];
    CGFloat indicatorX = (_window.bounds.size.width - labelTextSize.width) / 2 - WindowHeight*2;
    indicatorView.frame = CGRectMake(indicatorX, 0, WindowHeight, WindowHeight);
